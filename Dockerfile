...
WORKDIR /app
COPY --from=chef /app/target/release/layerzero-executor-blueprint-template /usr/local/bin
...
LABEL org.opencontainers.image.source="https://github.com/tangle-network/layerzero-executor-blueprint-template"
